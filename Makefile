...
# Base Definitions
DEFINES = -D_DEFAULT_SOURCE -DFMSX -DUNIX -DMITSHM -DBPS16 -DPULSE_AUDIO -DZLIB -DCONDEBUG -DDEBUG
...
ifeq ($(UNAME_S), Darwin)
    ...
    # Try using pkg-config if available, otherwise fallback to defaults
